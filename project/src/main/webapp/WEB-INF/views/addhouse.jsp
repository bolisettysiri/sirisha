...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <c:url var="addhouse" value="addhouse"></c:url>
   <form:form commandName="Product" method="post" action="storehouse" enctype="multipart/form-data">
       <table class="table table-bordered" >
           ...
           <tr><td><form:label path="img">house Image:</form:label></td>
